            ...
            formatter: function (value, row, index) {
                if (value != null) {
                    ...
                    return date.getFullYear() + "-"
                        + eval(date.getMonth() + "+1") + "-" + date.getDate();
                }
            }
        },
        {
...
function getData() {
    ...
    if(btime=="" || btime==null ){
        ...
        bgtimes = new Date(btime).getTime();
        $("#bgtime").val(bgtimes);
    }
    if (etime=="" || etime==null){
        edtimes==null;
        ...
        edtimes = new Date(etime).getTime();
        $("#edtime").val(edtimes);
    }
    if (etime != null && etime != '' && btime != null && btime != '') {
        if (etime > btime) {
            ...
            $('#table').bootstrapTable('refreshOptions',{pageNumber:1,pageSize:3});
        } else {
